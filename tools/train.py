...
# Written by Bin Xiao (leoxiaobin@gmail.com) and Bowen Cheng (bcheng9@illinois.edu)
# Modified by ManiaaJia
# ------------------------------------------------------------------------------
...
from core.loss import DaeLossFactory
...
def parse_args():
    ...
    # ! distributed training with "gpu" "world-size" "dist-url" "rank"
...
def main():
    ...
    # * 1.final_output_dir = "output/crowd_pose_kpt/pose_higher_hrnet/w32_512_adam_lr1e-3"
    # * 2.tensorboard_log_dir = "log/crowd_pose_kpt/pose_higher_hrnet/w32_512_adam_lr1e-3_{time_str}"
    # * 3.logger is a instance of logging, the runtime log will be written in final_log_file
    # *     final_log_file = final_output_dir/{train}_{time_str}_rank{0}.log
...
def main_worker(
    ...
    if args.distributed:
        ...
        print(
            "Init process group: dist_url: {}, world_size: {}, rank: {}".format(
                args.dist_url, args.world_size, args.rank
            )
        )
    ...
    # * logger is a instance of logging, the runtime log will be written in final_log_file
    # * final_log_file = final_output_dir/{train}_{time_str}_rank{0}.log
    ...
    # ! model: in our exps, distributed is False
    if args.distributed:
    ...
    loss_factory = DaeLossFactory(cfg)
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        if not cfg.MULTIPROCESSING_DISTRIBUTED or (
            ...
            save_checkpoint(
                ...
                best_model,
                final_output_dir,
                filename = "epoch{}.pth.tar".format(epoch)
            )
