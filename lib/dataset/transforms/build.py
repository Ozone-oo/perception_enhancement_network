...
FLIP_CONFIG = {
    ...
    "CROWDPOSE_WITH_DAE": [
        0, 1, 5, 6, 7, 2, 3, 4, 8, 12, 13, 14, 9, 10, 11, 15
    ],
    "COCO_WITH_DAE": [
...
def build_transforms(cfg, is_train=True):
    ...
    if 'crowd_pose_kpt_dae' in cfg.DATASET.DATASET:
        dataset_name = 'CROWDPOSE_WITH_DAE'
    if 'coco_kpt_dae' in cfg.DATASET.DATASET:
        dataset_name = 'COCO_WITH_DAE'
